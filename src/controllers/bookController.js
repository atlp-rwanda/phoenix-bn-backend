...
export default class controller {
    ...
    static async bookAccomodation(req, res) {
        try {
            ...
            if (accomodation.roomLeft > 0) {
                await accomodationService.updateAtt({ roomLeft: (accomodation.roomLeft - 1) }, { id: roomInfos.accomodation_id });
                const data = { userId, accomodation_id, checkIn, checkOut };
